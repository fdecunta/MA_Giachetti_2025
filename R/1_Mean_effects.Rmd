...
map <- map +
    geom_point(data = dat,
               ...
               alpha = 0.6,
               stroke = .6) +
    scale_fill_gradient2(midpoint = 0.5, low = "red", mid = "yellow",
                         high = "steelblue", space = "Lab") +
    labs(fill = "Aridity index")
...
whittaker <- whittaker_base_plot() +
    ...
    scale_color_gradient2(midpoint = 0.5, low = "red", mid = "yellow",
                          high = "steelblue", space = "Lab") +
    guides(colour = "none")
...
```{r}
layout <- c(area(1, 1, 1, 5),
            area(2, 2, 2, 4))

layout

fig1 <- map + whittaker + plot_layout(design = layout)
fig1
```
...
```{r}
ggsave(filename = "../figures/Map.jpeg",
       plot = map,
       width = 2400,
       height = 1000,
       units = "px")
...
```{r}
ggsave(filename = "../figures/Whittaker.jpeg",
       plot = whittaker,
       width = 1600,
       height = 1100,
       units = "px")
...
ggsave(filename = "../figures/Whittaker.pdf",
       devide = "pdf",
       plot = whittaker,
       width = 1600,
       height = 1100,
